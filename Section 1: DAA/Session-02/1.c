...
// 1. Implement the Fractional Knapsack algorithm and find out the optimal result for the following problem instances:
...
int main() {
   double profits[] = {15, 5, 20, 8, 7, 20, 6};
   double weights[] = {3, 4, 6, 8, 2, 2, 3};
   int n = 7;
   double capacity = 18;
